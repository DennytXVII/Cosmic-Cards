...
public class DarknessElementNPC extends NPC {
    private Random random;
    private CardLog cardLog;

    public DarknessElementNPC(String name, cardLog cardLog) {
        super(name);
    ...
    public void chooseInitialCards() {
        List<Card> darknessCards = cardLog.getDarknessElementCards();
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (chance < 0.1) { // 0.1% chance for a Boss Card
                ...
                randomCard = getRandomCardWithRarity(darknessCards);
            }
