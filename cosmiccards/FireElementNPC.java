...
public class FireElementNPC extends NPC {
    private Random random;
    private CardLog cardLog;

    public FireElementNPC(String name, cardLog cardLog) {
        super(name);
    ...
    public void chooseInitialCards() {
        List<Card> fireCards = cardLog.getFireElementCards();
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (chance < 0.1) { // 0.1% chance for a Boss Card
                ...
                randomCard = getRandomCardWithRarity(fireCards);
            }
