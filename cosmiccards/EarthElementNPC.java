...
public class EarthElementNPC extends NPC {
    private Random random;
    private CardLog cardLog;

    public EarthElementNPC(String name, cardLog cardLog) {
        super(name);
    ...
    public void chooseInitialCards() {
        List<Card> earthCards = cardLog.getEarthElementCards();
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (chance < 0.1) { // 0.1% chance for a Boss Card
                ...
                randomCard = getRandomCardWithRarity(earthCards);
            }
