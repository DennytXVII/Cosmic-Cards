...
public class LightElementNPC extends NPC {
    private Random random;
    private CardLog cardLog;

    public LightElementNPC(String name, cardLog cardLog) {
        super(name);
    ...
    public void chooseInitialCards() {
        List<Card> lightCards = cardLog.getLightElementCards();
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (chance < 0.1) { // 0.1% chance for a Boss Card
                ...
                randomCard = getRandomCardWithRarity(lightCards);
            }
